            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input value="baju" name="product" id="baju" type="radio" class="custom-control-input" required>
                        <label for="baju" class="custom-control-label">Baju</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input value="topi" name="product" id="topi" type="radio" class="custom-control-input" required>
                        <label for="topi" class="custom-control-label">Topi</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input value="jamtangan" name="product" id="jamtangan" type="radio" class="custom-control-input" required>
